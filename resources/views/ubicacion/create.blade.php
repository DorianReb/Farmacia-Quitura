<div class="modal fade" id="createModalUbicacion" tabindex="-1" aria-labelledby="createUbicacionLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">

            {{-- Header del modal --}}
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="createUbicacionLabel">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ubicacion.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="nivel_id" id="nivel_id" class="form-select @error('nivel_id') is-invalid @enderror" required>
...
@if ($errors->any() && session('from_modal') === 'create_ubicacion')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const el = document.getElementById('createModalUbicacion');
