...
<head>
    ...
    <style>
        /* Tamaño aproximado de ticket térmico */
        @page {
            size: 58mm auto;
            margin: 4mm 3mm;
        }
...
<div class="ticket-container">
    ...
    @foreach($venta->detalles as $detalle)
        @php
            ...
            // % de descuento (viene del controlador)
            $porcDesc = max((float) ($detalle->descuento ?? 0), 0);

            // Subtotal final de la línea (después del descuento)
            ...
            if ($subtotalFinal > 0 && $cant > 0) {
                if ($porcDesc > 0 && $porcDesc < 100) {
                    // Recuperar subtotal ANTES del descuento
